    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] gap-4 px-4 pb-5 pt-1">
          <div>
            <div className="text-[10.5px]" style={{ color: T.text2 }}>Security Score</div>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-[10px]" style={{ color: T.text2 }}>vs last scan</span>
            </div>

            <div className="my-3.5 h-px w-full" style={{ background: T.border }} />

            <div className="text-[10px]" style={{ color: T.text3 }}>Findings</div>
              ...
              <div className="relative flex-1">
                ...
                <div className="mt-3 space-y-2">
                  {[
                    ...
                    <div key={b.label}>
                      <div className="flex items-center justify-between text-[9.5px]" style={{ color: T.text2 }}>
                        <span>{b.label}</span>
                        <span style={{ color: T.text }}>
