  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ background: T.bg }}>
      ...
      <div className="relative mx-auto max-w-[1360px] px-3 sm:px-8 pt-20 sm:pt-28 pb-10 sm:pb-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-8 lg:gap-14 items-stretch sm:items-center">
          <div className="min-w-0 text-center sm:text-left">
            ...
            <div className="hidden sm:block">
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.08 }}
                className="mt-6 sm:mt-7 leading-[0.95] whitespace-nowrap text-[26px] lg:text-[32px]"
                style={{
                  fontFamily: "ui-sans-serif, system-ui, sans-serif",
                  fontWeight: 700,
                  letterSpacing: "0.02em",
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.2 }}
                className="mt-4 sm:mt-5 max-w-xl text-[17px] leading-relaxed"
                style={{ color: T.text2 }}
              >
            ...
            <motion.div
              ...
              className="mt-6 sm:mt-9 hidden sm:flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-3"
            >
              <a
                href="/pricing"
        ...
        <div
          className="hidden sm:flex mt-10 flex-wrap items-center justify-center gap-x-8 gap-y-3 text-[11px] uppercase tracking-[0.25em]"
          style={{ color: T.text3 }}
        >
