...
function SearchBar({ q, setQ }: { q: string; setQ: (s: string) => void }) {
  return (
    <div
      className="group relative flex items-center gap-2 rounded-[18px] border border-blue-500/25 bg-white/[0.04] backdrop-blur-xl px-3 sm:px-4 py-2.5 sm:py-3 shadow-[0_0_8px_-2px_rgba(59,130,246,0.25)]"
    >
